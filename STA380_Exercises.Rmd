...
plot(density(greens$Rent), lwd = 2, col = "red", main = "Density plots", xlab = "", ylim=c(0, 0.05))
...
plot(density(greens$cluster_rent), lwd = 2, col = "red", main = "Density plots", xlab = "", ylim=c(0, 0.06))
